...
I’m a software engineer at [JetBrains](https://www.jetbrains.com/) since 2013, working on developer tools, IDEs and (lately) AI-assisted development.
...
* Author of the **.NET debugger in [Rider](https://www.jetbrains.com/rider/)**
...
* Author of the **[Kotlin SDK for Agent Client Protocol (ACP)](https://github.com/agentclientprotocol/kotlin-sdk)**
* Contributor to the **[Agent Client Protocol](https://agentclientprotocol.com/)** and its ecosystem
* Occasionally advise different teams on architecture and tooling, including, for example, the OSS project [JetBrains Koog](https://github.com/JetBrains/koog)
